package a_fundamental.intrinsic_locks_and_synchronization;
...
/*
    Предположим, например, что класс LocksObjects два поля экземпляра c1 и c2, которые никогда не используются вместе.
